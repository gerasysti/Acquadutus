inherited frmLanctoLeituraHidrom: TfrmLanctoLeituraHidrom
  Left = 94
  Top = 118
  Caption = 'frmLanctoLeituraHidrom'
  ClientHeight = 650
  ClientWidth = 979
  Color = clWhite
  OnCreate = FormCreate
    ...
    object dbgLeitura: TcxGrid
      ...
      object GridDBTableView1: TcxGridDBTableView
        ...
        object GridDBTableView1Column2: TcxGridDBColumn
          ...
          DataBinding.FieldName = 'LEITURA_ANTERIOR'
          Width = 87
        end
  ...
  object gbEvento: TcxGroupBox
    ...
    object Label1: TLabel
      ...
      AutoSize = False
      Caption = 'Total de m'#179' do Logradouro:'
    ...
    object edTotM3Lograd: TcxCurrencyEdit
      Left = 756
      Top = 17
      TabStop = False
      AutoSize = False
  ...
  object Panel: TPanel
    ...
    object btnHistFaturas: TBitBtn
      ...
      Width = 154
      Height = 30
      Caption = '&Hist'#243'rico de Lan'#231'tos'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
  ...
  object cds1: TClientDataSet
    ...
    object cds1TIPO_PESSOA: TStringField
  ...
  object qry1: TSQLQuery
    ...
    SQL.Strings = (
      'select * from leitura_hidrometro'
      'where'
      '(ano_mes = :pAnoMes) and'
    ...
    object qry1TIPO_PESSOA: TStringField
      FieldName = 'TIPO_PESSOA'
      ProviderFlags = []
      FixedChar = True
      Size = 1
