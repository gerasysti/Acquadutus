inherited frmFindRequerimento: TfrmFindRequerimento
  Left = 127
  Top = 126
  Caption = 'P E S Q U I S A N D O    R E Q U E R I M E N T O  . . . '
  ClientHeight = 670
  ClientWidth = 984
  OnClose = FormClose
  OnCreate = FormCreate
  ...
  object Panel1: TPanel
    ...
    object chbOcultInativo: TcxCheckBox
      Left = 3
      Top = 8
      Caption = '...'
      ParentFont = False
  ...
  object Panel2: TPanel
    ...
    object btnExecPesquisa: TBitBtn
      Left = 790
      Top = 8
      Width = 94
      Height = 34
  ...
  object GridTable1: TcxGrid
    ...
    object GridTableDBTableView1: TcxGridDBTableView
      ...
      OnCellDblClick = GridTableDBTableView1CellDblClick
      DataController.DataSource = dsRequerimento
      ...
      object GridTableDBTableView1Column6: TcxGridDBColumn
        Caption = 'Data'
        DataBinding.FieldName = 'DATA_REQUER'
      ...
      object GridTableDBTableView1Column8: TcxGridDBColumn
        Tag = 1
        Caption = 'Servi'#231'o Requerido'
        DataBinding.FieldName = 'DESCR_SERVICO'
        Width = 184
      end
      object GridTableDBTableView1Column4: TcxGridDBColumn
        Tag = 1
        Caption = 'Dt.Protocolo'
        DataBinding.FieldName = 'DATA_PROTOCOL'
        Width = 79
      end
  ...
  object cdsRequerimento: TClientDataSet
    ...
    OnFilterRecord = cdsRequerimentoFilterRecord
    Left = 336
    Top = 272
