inherited frmLanctoOutroItemFatura: TfrmLanctoOutroItemFatura
  Left = 125
  Top = 97
  Caption = 'frmLanctoOutroItemFatura'
  ClientHeight = 650
  ClientWidth = 1121
  OnCreate = FormCreate
    ...
    object dbg1: TcxGrid
      ...
      object GridDBTableView1: TcxGridDBTableView
        ...
        object GridDBTableView1Column2: TcxGridDBColumn
          Caption = 'Id. '#205'tem'
          DataBinding.FieldName = 'ID_OUTRO'
          Width = 44
        end
        object cxGridDBColumn5: TcxGridDBColumn
          Caption = 'Descri'#231#227'o do '#205'tem'
          DataBinding.FieldName = 'DESCR_OUTRA_TARIFA'
          Width = 166
        end
  ...
  object cxGroupBox1: TcxGroupBox
    ...
    object Label3: TLabel
      ...
      Width = 187
      Height = 13
      Caption = 'Lan'#231'amentos referentes ano M'#234's/Ano:'
    end
    ...
    object edAno: TcxSpinEdit
      ...
      Properties.MinValue = 1996.000000000000000000
      Style.Font.Charset = DEFAULT_CHARSET
      Style.Font.Color = clWhite
  ...
  object qryUsuarioPermissaoTabela: TSQLQuery
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    Left = 472
    Top = 160
    object qryUsuarioPermissaoTabelaINCLUIR: TStringField
      FieldName = 'INCLUIR'
      Required = True
      FixedChar = True
      Size = 1
    end
    object qryUsuarioPermissaoTabelaALTERAR: TStringField
      FieldName = 'ALTERAR'
      Required = True
      FixedChar = True
      Size = 1
    end
    object qryUsuarioPermissaoTabelaEXCLUIR: TStringField
      FieldName = 'EXCLUIR'
      Required = True
      FixedChar = True
      Size = 1
