inherited frmSelecionaLogradouro: TfrmSelecionaLogradouro
  Caption = 'frmSelecionaLogradouro'
  ClientHeight = 339
  ClientWidth = 625
  ExplicitWidth = 631
  ExplicitHeight = 368
  ...
  inherited qry1: TSQLQuery
    ...
    SQL.Strings = (
      'select id, descricao, nome_distrito'
      'from logradouro'
      'where '
  ...
  inherited cds1: TClientDataSet
    ...
    object cds1NOME_DISTRITO: TStringField
