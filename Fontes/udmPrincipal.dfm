object dmPrincipal: TdmPrincipal
  ...
  object SConPrincipal: TSQLConnection
    ...
    Params.Strings = (
      ...
      'Password=gsti2010'
        ...
        'Database=D:\Aplicativos\Delphi2010\AcquaDutus\Dados\ACQUA_DEVELO' +
        'P.FDB'
  ...
  object spSalvaFatura: TSQLStoredProc
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftString
      ...
      item
        DataType = ftInteger
        Precision = 4
        Name = 'PE_QTD_TORNEIRA'
        ParamType = ptInput
      end
      item
        DataType = ftInteger
        Precision = 4
        Name = 'PE_MULTIPLICADOR'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Precision = 12
        Name = 'PE_NUM_HIDROMETRO'
        ParamType = ptInput
      end
      item
        DataType = ftCurrency
      ...
      item
        ...
        Precision = 15
        NumericScale = 2
        Name = 'PE_VAL_OUTRO_CRED'
        ParamType = ptInput
      end>
    SQLConnection = SConPrincipal
    StoredProcName = 'SP_SALVA_FAT_MES_UNID_CONSUM'
    Left = 336
    Top = 48
  end
  object spSalvaMulta: TSQLStoredProc
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    SQLConnection = SConPrincipal
    StoredProcName = 'SP_SALVA_MULTA_UNID_CONSUM'
    Left = 336
    Top = 96
  end
end
